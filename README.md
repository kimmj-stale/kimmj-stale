...
###
올해의 목표 : Java 알고리즘 골드 달성 - ✔️ / Spring Boot web project 하나 만들어보기 - ✔️ / 프로젝트 경험 마구마구 쌓기 - / side project 하나 만들기 - / rest API - / ERD 숙련 - / JPA - / MySQL - /
           
###
오늘 일정 :   알고리즘 문제 하나 풀기 (백준 1463번 - 1로 만들기) - / 프로젝트 전체 회의 - ✔️ / 

###
주간 일정 :  모바일 프로그래밍 과제 - ✖️ / 임베디드 과제 - ✖️ / 알고리즘 기초 과제(~11/4) -  / 성서와 기독교 과제 -  /
           알고리즘 기초 퀴즈(Hashing without chain 까지, 11/10 , 컨323호) - 
